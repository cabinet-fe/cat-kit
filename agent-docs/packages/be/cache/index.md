...
- [lru-cache.d.ts](../../../../packages/be/dist/cache/lru-cache.d.ts) —— `LRUCache`、`LRUCacheOptions`
- [file-cache.d.ts](../../../../packages/be/dist/cache/file-cache.d.ts) —— `FileCache`、`FileCacheOptions`
- [memoize.d.ts](../../../../packages/be/dist/cache/memoize.d.ts) —— `memoize`、`MemoizeOptions`、`CacheAdapter`
