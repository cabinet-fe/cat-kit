...
| 你的任务                                     | 推荐包                     | 继续阅读                                                                                        |
| -------------------------------------------- | -------------------------- | ----------------------------------------------------------------------------------------------- |
| 通用工具函数、日期处理、数据结构             | `@cat-kit/core`            | [数据处理](/packages/core/data-structure) / [日期处理](/packages/core/date)                     |
...
| ----------------------------------------------------------------------------------------------------------------- | -------------------------- | -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| 数组、对象、字符串、日期、比较、格式化、环境检测                                                                  | `@cat-kit/core`            | [Core 核心包](/packages/core/)               | [数据处理](/packages/core/data-structure) / [日期处理](/packages/core/date) / [环境检测](/packages/core/env)                                   | `core data date env pattern optimize`                                                                                                       |
