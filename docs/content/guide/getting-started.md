...
| agent、ac-workflow、init、plan、replan、implement、patch、rush、done、CLI                           | `@cat-kit/agent-context` | [Agent Context](/packages/agent-context/)        | [Action 说明](/packages/agent-context/actions) / [AI 协作场景](/packages/agent-context/collaboration) / [CLI 命令](/packages/agent-context/cli)                                    | `agent-context ac-workflow init plan replan implement patch rush done cli` |
