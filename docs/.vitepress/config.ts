...
export default defineConfig({
  ...
  head: [
    ['link', { rel: 'icon', type: 'image/png', href: '/cat-kit/logo.png' }],
    ...
    ['meta', { property: 'og:description', content: '基于 TS 的全环境开发工具包' }]
  ],
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/cabinet-fe/cat-kit' }],
